...
class login
{
	...
	{
		$sql = "SELECT email, p_nombre, p_apellido, id_usuario, rol, contraseñacol
		 FROM usuarios U INNER JOIN roles_usuario R 
		 ON  R.idrol_usuario = U.roles_usuario_idrol_usuario 
		 INNER JOIN contraseñas C 
		 ON C.contraseñacol = '" . $this->getContrasena() . "' 
		 WHERE u.email = '" . $this->getNombreUsuario() . "'";
